...
const file_publisher_proto_rawDesc = "" +
	"\n" +
	"\x0fpublisher.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xb8\x01\n" +
	"\bTaskSpec\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x10\n" +
	"\x03loc\x18\x03 \x01(\tR\x03loc\x12#\n" +
	"\rassigned_node\x18\x04 \x01(\tR\fassignedNode\x12#\n" +
	"\rcreation_time\x18\x05 \x01(\x03R\fcreationTime\x12\x18\n" +
	"\asumname\x18\x06 \x01(\tR\asumname\x12\x12\n" +
	"\x04type\x18\a \x01(\tR\x04type2V\n" +
	"\tPublisher\x12I\n" +
	"\bPushTask\x12\t.TaskSpec\x1a\x16.google.protobuf.Empty\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/publisher/taskB\rZ\v./publisherb\x06proto3"
