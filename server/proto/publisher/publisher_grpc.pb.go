...
type PublisherClient interface {
	PushTask(ctx context.Context, in *TaskSpec, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *publisherClient) PushTask(ctx context.Context, in *TaskSpec, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Publisher_PushTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPublisherServer) PushTask(context.Context, *TaskSpec) (*emptypb.Empty, error) {
