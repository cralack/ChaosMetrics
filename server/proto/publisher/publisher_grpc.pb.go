...
type PublisherClient interface {
	...
	PullTask(ctx context.Context, in *TaskSpec, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *publisherClient) PullTask(ctx context.Context, in *TaskSpec, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedPublisherServer) PullTask(context.Context, *TaskSpec) (*emptypb.Empty, error) {
