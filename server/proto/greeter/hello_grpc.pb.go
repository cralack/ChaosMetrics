...
func (c *greeterClient) Hello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedGreeterServer) Hello(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
